...
| Time Quantum | `SETQ` constraints  | [IDSETQ data type](/docs/sql-guide/data-types/data-type-set-setqq)  <br/>[STRINGSETQ data type](/docs/sql-guide/data-types/data-type-set-setqq) |
| Timestamp | Data type | [Timestamp data type](/docs/sql-guide/data-types/data-type-timestamp) |
| TTL (Time To Live) | `SETQ` constraints  | [IDSETQ data type](/docs/sql-guide/data-types/data-type-set-setqq)  <br/>[STRINGSETQ data type](/docs/sql-guide/data-types/data-type-set-setqq) |
