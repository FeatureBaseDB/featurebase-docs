...
| `set` | ![expr](/assets/images/sql-guide/set_literal.svg) | [IDSET data type](/docs/sql-guide/data-types/data-type-set)<br/>[STRINGSET data type](/docs/sql-guide/data-types/data-type-set) |
