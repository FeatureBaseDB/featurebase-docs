...
| `time_quantum` | string | Applies to `IDSETQ()` and `STRINGSETQ()` columns | [IDSETQ() data type](/docs/sql-guide/data-types/data-type-setq)<br/>[STRINGSETQ() data type](/docs/sql-guide/data-types/data-type-setq) |
| `ttl` | string | Applies to `IDSETQ()` and `STRINGSETQ()` columns | [IDSETQ() data type](/docs/sql-guide/data-types/data-type-setq)<br/>[STRINGSETQ() data type](/docs/sql-guide/data-types/data-type-setq) |
